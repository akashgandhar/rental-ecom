...
import icon3 from "../../../public/assets/store-card-40-watch-s10-202409 (3).png"
...
const equipmentList = [
  {
    ...
    image: icon3, // Add these images in /public/images/
  }
];
...
const EquipmentCard = (item) => {
  return (
    ...
    >
      ...
      {/* Equipment Image */}
      <Image src={icon3} alt="images" width={250} height={200} style={{ objectFit: "contain" }} />
